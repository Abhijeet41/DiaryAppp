...
import com.diary41.ui.components.DisplayAlertDialog
import com.diary41.util.toInstant
...
internal fun WriteTopBar(
    ...
    //we define selectedDiary as a key because when selectedDiary change then only recomposition should
